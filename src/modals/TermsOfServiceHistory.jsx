// LootLedger — Terms of Service version history viewer.
// Mirrors src/modals/PrivacyPolicyHistory.jsx with paths swapped to
...
export default function TermsOfServiceHistory({settings,setSettings,activeStaff,pop,onClose,onRestoredOpenForm}){
  ...
  if(selectedVersion){
    return <Modal title={"📜 Terms of Service v"+sS(selectedVersion.version)} onClose={()=>setSelectedVersion(null)} wide>
  ...
  return <Modal title="📜 Terms of Service — Version History" onClose={onClose} wide>
