...
// staffPin: legacy key — UI now labels this "Admin PIN" (Phase 2.7
//   smoke-test follow-up, 2026-04-29). Key intentionally unchanged
//   to avoid migrating every existing settings store.
// manualPriceTTL: TTL of the manual spot-price override.
//   Values: "always" | "1h" | "6h" | "12h" | "24h". "always" = no
//   countdown, never auto-expires. Refresh / Resume API always
//   cancels regardless of this setting.
// stripe*: dormant by default. Activated via the Settings →
//   Integrations toggle; nothing fires until both the toggle is on
//   and a secret key is present. See src/lib/integrations/stripe.js.
// adminRecovery*: written ONCE at first-time PIN setup, then only
//   the encrypted blob rotates on PIN changes. salt + hash never
//   change — they're tied to the original passphrase. Phone is the
//   future SMS recovery target (deferred to Phase 3 alongside full
//   staff auth). See src/lib/auth/passphrase.js.
// amlProgram: the in-app AML/CTF Program form. Stored as JSONB on
//   settings so it travels with the shop and survives page reload.
//   Shape:
//     { currentVersion: "1.0" | null,
//       versions: [{version, savedAt, savedBy, approvedBy,
//                   approvedAt, data}, ...],
//       draft: {data, savedAt, savedBy} | null }
//   Each Save & Approve creates a new entry in versions[]; older
//   versions remain immutable for audit. Save Draft writes only to
//   draft. See src/modals/AmlProgramForm.jsx.
export const DEFAULT_SETTINGS={businessName:"",abn:"",address:"",phone:"",staffPin:"1234",squareToken:"",squareLoc:"",squareRedirect:"",sheetsId:"",sheetsRange:"Sheet1!A1",sheetsToken:"",webhookUrl:"",shopifyDomain:"",shopifyToken:"",xeroToken:"",xeroTenantId:"",xeroBuyCode:"310",xeroSellCode:"200",xeroBuyCodeHobby:"315",requirePin:false,sessionTimeout:"never",ttrEnabled:true,cashHardBlockAbove:null,manualPriceTTL:"1h",eftposProvider:"none",squareTerminalId:"",linklyBaseUrl:"http://localhost:4242",aiAgentEnabled:false,aiAgentLevel:1,aiAgentUrl:"",aiAgentName:"Sophiie",cryptoEnabled:false,walletBTC:"",walletETH:"",walletBNB:"",walletXRP:"",walletSOL:"",goldApiKey:"",metalsApiKey:"",metalsDevKey:"",duressContact1:"",duressContact2:"",duressContact3:"",duressContact4:"",duressContact5:"",duressContact6:"",duressContact7:"",duressContact8:"",duressContact9:"",duressContact10:"",smsProvider:"textbelt",textbeltKey:"textbelt",duressWebhookUrl:"",twilioFnUrl:"",policeEmail:"",policeStation:"",dealerLicenceNo:"",logoImg:null,scaleProtocol:"auto",scaleCustomServiceUUID:"",scaleCustomCharUUID:"",scaleUnit:"g",scaleFilter:true,state:"VIC",goldAlert:null,silverAlert:null,cashKycThreshold:null,bullionCddThreshold:null,sourceOfFundsCashThreshold:null,sourceOfWealthCashThreshold:null,idAutofillProvider:"none",googleVisionApiKey:"",googleVisionProjectId:"",awsTextractAccessKey:"",awsTextractSecretKey:"",awsTextractRegion:"",llmVisionSubProvider:"anthropic",llmVisionApiKey:"",llmVisionModel:"",llmVisionEndpoint:"",stripeEnabled:false,stripePublishableKey:"",stripeSecretKey:"",stripeMode:"test",stripeWebhookUrl:"",adminRecoverySalt:"",adminRecoveryPassphraseEncrypted:"",adminRecoveryPassphraseHash:"",adminRecoveryPhone:"",requireIdOnEveryTx:true,amlProgram:{currentVersion:null,versions:[],draft:null},privacyPolicy:{currentVersion:null,versions:[],draft:null},termsOfService:{currentVersion:null,versions:[],draft:null}};
